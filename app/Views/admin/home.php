...
?>
<h1>Genel Bakış</h1>
<p class="muted" style="margin-top:-2px;margin-bottom:18px"><?= esc($dateStr) ?></p>

<div class="tiles" style="margin-bottom:20px">
    <div class="tile"><span class="box ic in"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3.2"/><path d="M3.5 20a5.5 5.5 0 0 1 11 0"/><path d="M16 5.2a3 3 0 0 1 0 5.6"/><path d="M19.8 20a5 5 0 0 0-3-4.6"/></svg></span><div><div class="v"><?= (int) $activeCount ?></div><div class="l">Aktif çalışan</div></div></div>
    <div class="tile"><span class="box ic ot"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M8 12l3 3 5-6"/></svg></span><div><div class="v"><?= (int) $presentCount ?></div><div class="l">Bugün gelen</div></div></div>
    <div class="tile"><span class="box ic late"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg></span><div><div class="v"><?= (int) $lateCount ?></div><div class="l">Bugün geç gelen</div></div></div>
    <a class="tile" href="<?= site_url('admin/requests') ?>" style="text-decoration:none;color:inherit"><span class="box ic pur"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M9 14l2 2 4-4"/></svg></span><div><div class="v"><?= (int) $pendingTotal ?></div><div class="l">Bekleyen talep</div></div></a>
</div>
...
<div class="split-2">
    ...
    <div class="info-card">
        <div class="ic-head"><span class="box ic pur"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8a6 6 0 1 0-12 0c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.7 21a2 2 0 0 1-3.4 0"/></svg></span><span class="ttl">Bekleyen talepler</span></div>
...
<div class="dash-grid">
    <div class="info-card">
        ...
        <div class="info-row"><span class="box ic pur"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg></span><span class="txt"><b>Manuel giriş</b></span><span class="num"><?= (int) $inManual ?></span></div>
    ...
    <div class="info-card">
        ...
        <div class="info-row"><span class="box ic pur"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg></span><span class="txt"><b>Manuel çıkış</b></span><span class="num"><?= (int) $outManual ?></span></div>
...
(function () {
    ...
    new Chart(el, {
        ...
        data: { labels: <?= $chartLabels ?>, datasets: [
            { label: 'Giriş', data: <?= $chartIn ?>, backgroundColor: '#4f46e5', borderRadius: 6, maxBarThickness: 22 },
