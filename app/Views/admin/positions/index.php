...
<div class="card-head">
    ...
    <a class="btn btn-primary" href="<?= site_url('admin/positions/new') ?>">+ Yeni pozisyon</a>
</div>
<div class="card">
    <?php if (empty($positions)): ?>
        <?= view('partials/empty', ['title' => 'Henüz pozisyon yok', 'message' => 'İlk pozisyonunu ekleyerek başla.', 'actionUrl' => site_url('admin/positions/new'), 'actionLabel' => '+ Yeni pozisyon']) ?>
    <?php else: ?>
